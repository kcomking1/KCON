...
namespace NPOI
{
    ...
    public class FluentConfiguration<TModel> : IFluentConfiguration where TModel : class
    {
        ...
        private IList<StatisticsHeadConfig> _statisticsHeadConfigs;
        ...
        public FluentConfiguration()
        {
            ...
            _statisticsHeadConfigs = new List<StatisticsHeadConfig>();
        ...
        IList<StatisticsHeadConfig> IFluentConfiguration.StatisticsHeadConfigs
        {
            get
            {
                return _statisticsHeadConfigs;
            }
        }
