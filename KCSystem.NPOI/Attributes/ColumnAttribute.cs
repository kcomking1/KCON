...
namespace NPOI
{
    ...
    public class ColumnAttribute : Attribute
    {
        ...
        /// <summary>
        /// If <see cref="Index"/> was not set and AutoIndex is true NPOI will try to autodiscover the column index by its <see cref="Title"/> property.
        /// </summary>
        ...
        public int RowSpan
        {
            get
            {
                return CellConfig.RowSpan;
            }
            set
            {
                CellConfig.RowSpan = value;
            }
        }
        ...
        public int ColSpan
        {
            get
            {
                return CellConfig.ColSpan;
            }
            set
            {
                CellConfig.ColSpan = value;
            }
        }
