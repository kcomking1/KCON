...
//弹框成功提示
function dialogSuccess(msg,callback) {
    msg = msg || '操作成功'; 
    layer.msg(msg, {
        icon: 1,
...
//弹框成功提示
function dialogAlertSuccess(msg, callback) {
    msg = msg || '操作成功';
    layer.alert(msg, {
        icon: 1,
    }, function (index, layero) {
...
//弹框提示失败
function dialogAlertError(msg, callback) {
    msg = msg || '操作成功';
    layer.alert(msg, {
        icon: 5,
    }, function (index, layero) {
...
function dialogApproval(msg, succcess, cancel) {
    var _succcess = succcess || function () { };
    var _cancel = cancel || function () { };
    layer.confirm(msg,
        {
